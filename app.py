...
# Page Configuration
st.set_page_config(page_title="QuLab: Lab 4: Data Quality, Provenance & Bias Metrics Dashboard", layout="wide")
        ...
        if st.button("Generate Final Report and Export Artifacts", key="generate_reports_btn"):
            with st.spinner("Generating reports and bundling artifacts..."):
                ...
                st.session_state['reports_folder_path'] = generate_reports(
                    ...
                    st.session_state['assessment_config'],
                    st.session_state['primary_temp_path'] if st.session_state['primary_temp_path'] else st.session_state['primary_data_filename'],
